...
//******************************************************************************
    ...
    var scwBaseYear        = scwDateNow.getFullYear()-212;

    // How many years do want to be valid and to show in the drop-down list?

    var scwDropDownYears   = 211;
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            '.scw           {padding:1px;vertical-align:middle; padding :0px;background: #069!important }'       +
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '*/'                                                        +
            'table.scw      {padding:       1px!important;'                       +
            ...
            'td.scwDrag,'                                               +
            'td.scwHead                 {padding:       0px!important;background: #069!important;'       +
                                        'text-align:    center!important;}'       +
            'td.scwDrag                 {font-size:     8pt!important;}'          +
            'select.scwHead             {margin:        3px 1px!important;'       +
                                        'text-align:    center!important;}'       +
            'input.scwHead              {height:        22px!important;'          +
            ...
            'td.scwWeek                 {padding:       0px!important;background: #069!important;'           +
                                        'text-align:    center!important;'        +
                                        'font-weight:   bold!important;}'         +
            'td.scwNow,'                                                +
            'td.scwNowHover,'                                           +
            'td.scwNow:hover,'                                          +
            'td.scwNowDisabled          {padding:       0px!important;'           +
                                        'text-align:    center!important;'        +
                                        'vertical-align:middle!important;'        +
                                        'font-weight:   normal!important;}'       +
            'table.scwCells             {text-align:    right!important;'         +
            ...
            'td.scwWeekNo,'                 +
            'td.scwWeeks                {padding:           3px!important;'       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #069!important;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #9999CC!important;'   +
                                        'color:             #CCCCFF!important;}'  +
            '/* Week number heading */'                                 +
            'td.scwWeekNumberHead       {color:             #069!important;}'  +
            '/* Week day headings */'                                   +
            'td.scwWeek                 {color:             #CCCCCC!important;}'  +
            '/* Week numbers */'                                        +
            'td.scwWeekNo               {background-color:  #776677!important;'   +
                                        'color:             #CCCCCC!important;}'  +
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            'td.scwCells                {background-color:  #CCCCCC!important;'   +
                                        'color:             #000000!important;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate            {background-color:  #CC9999!important;'   +
                                        'color:             #FF0000!important;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekend         {background-color:  #CCCCCC!important;'   +
                                        'color:             #CC6666!important;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth         {background-color:  #CCCCCC!important;'   +
                                        'color:             #666666!important;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #069!important;'   +
                                        'color:             #FFFFFF!important;}'  +
            '/* Clear Button */'                                        +
            'td.scwClear                {padding:           0px!important;}'      +
            'input.scwClear             {padding:           0px!important;'       +
                                        'text-align:        center!important;'    +
                                        'font-size:         8pt!important;}'      +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  #FFFF00!important;'   +
                                        'cursor:            pointer!important;'   +
                                        'color:             #000000!important;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            'td.scwInputDateHover       {background-color:  #FFFF00!important;'   +
                                        'cursor:            pointer!important;'   +
                                        'color:             #000000!important;}'  +
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #FFFF00!important;'   +
                                        'cursor:            pointer!important;'   +
                                        'color:             #000000!important;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  #FFFF00!important;'   +
                                        'cursor:            pointer!important;'   +
                                        'color:             #000000!important;}'  +
            '/* Today selector */'                                      +
            'td.scwNow:hover,'                                          +
            'td.scwNowHover             {color:             #FFFF00!important;'   +
                                        'cursor:            pointer!important;'   +
                                        'font-weight:       bold!important;}'     +
            '/* Disabled cells */'                                      +
            '/* Week Day */'                                            +
            '/* Day matching the input date */'                         +
            'td.scwInputDateDisabled    {background-color:  #999999!important;'   +
                                        'color:             #000000!important;}'  +
            'td.scwCellsDisabled        {background-color:  #999999!important;'   +
                                        'color:             #000000!important;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekendDisabled {background-color:  #999999!important;'   +
                                        'color:             #CC6666!important;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonthDisabled {background-color:  #999999!important;'   +
                                        'color:             #666666!important;}'  +
            'td.scwNowDisabled          {background-color:  #6666CC!important;'   +
                                        'color:             #FFFFFF!important;}'  +
        '</style>'
                    );
...
// ***************************
    ...
    document.write(
     ...
     "<table id='scw' class='scw'>" +
       "<tr class='scw'>" +
         "<td class='scw'>" +
           "<table class='scwHead' id='scwHead' width='100%' style='margin:0px' " +
            ...
            "<tr class='scwHead' >" +
                 ...
                 "<td class='scwHead'>" +
                    "<select id='scwMonths' style='padding:0; margin:0; height:20px;' class='scwHead' " +
                            "onchange='scwShowMonth(0);'>" +
                    "</select>" +
                 "</td>" +
                 "<td class='scwHead'>" +
                    "<select id='scwYears' style='padding:0; margin:0; height:20px;' class='scwHead' " +
                            "onchange='scwShowMonth(0);'>" +
                    "</select>" +
                 "</td>" +
                 "<td class='scwHead'>" +

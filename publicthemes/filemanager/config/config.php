...
$base_url="http://localhost:8086/food/publicthemes";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/filemanageruploads/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../filemanageruploads/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../filemanageruploads/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
